...
ALTER TABLE <change>
ADD COLUMN IF NOT EXISTS reverted_edit_predicted BOOLEAN DEFAULT FALSE;

ALTER TABLE <change>
ADD COLUMN IF NOT EXISTS reversion_predicted BOOLEAN DEFAULT FALSE;
...
UPDATE <change> c
SET reverted_edit_predicted = TRUE
WHERE EXISTS (
    SELECT 1
    FROM reverted rev
