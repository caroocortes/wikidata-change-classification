alter table :change
add column IF NOT EXISTS property_replacement BOOLEAN DEFAULT FALSE;

-- For cte1
CREATE INDEX idx_cte1_entity_oldvalue ON change_timestamp_entity(entity_id, old_value);

-- For cte2
CREATE INDEX idx_cte2_entity_newvalue ON change_timestamp_entity(entity_id, new_value);
