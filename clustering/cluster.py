...
import psycopg2
from sampling import stratified_sample_with_validation, get_data_from_db
...
if __name__ == "__main__":
    ...
    print(f'Credentials : {DB_USER}, {DB_PASS}, {DB_NAME}, {DB_HOST}, {DB_PORT}')
    df = get_data_from_db(conn, sql_untagged=True)
